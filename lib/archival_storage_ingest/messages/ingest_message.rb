...
module IngestMessage
  ...
  TYPE_TRANSFER_S3_WEST = 'Transfer S3 West'
  TYPE_TRANSFER_SFS = 'Transfer SFS'
  TYPE_TRANSFER_WASABI = 'Transfer Wasabi'
  ...
  WORK_TYPE_TO_QUEUE = {
    ...
    TYPE_TRANSFER_S3_WEST => Queues::QUEUE_TRANSFER_S3_WEST,
    TYPE_TRANSFER_SFS => Queues::QUEUE_TRANSFER_SFS,
    TYPE_TRANSFER_WASABI => Queues::QUEUE_TRANSFER_WASABI,
    TYPE_INGEST_FIXITY => Queues::QUEUE_INGEST_FIXITY,
